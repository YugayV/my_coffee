...
function getTutorialLessons() {
    return [
        {
            id: "license",
            title: "Права и документы для вождения",
            tags: ["права", "IDP", "перевод", "документы", "страховка"],
            html:
                "<h3>Что обычно нужно иметь при себе</h3>" +
                "<ul>" +
                "<li>Паспорт/ID и ваши водительские права.</li>" +
                "<li>Международное водительское удостоверение (IDP), если вы по нему ездите.</li>" +
                "<li>Контакты страховки/аренды (если аренда).</li>" +
                "</ul>" +
                "<h3>Полезные слова</h3>" +
                "<ul>" +
                "<li>운전면허 (унджон-мёнхо) — водительские права</li>" +
                "<li>보험 (похом) — страховка</li>" +
                "</ul>" +
                "<div class=\"tutorial-meta\">Всегда проверяйте актуальные правила для вашего статуса (турист/виза/ARC).</div>",
        },
        {
            id: "rental",
            title: "Аренда авто: как не попасть на деньги",
            tags: ["аренда", "rent", "депозит", "топливо", "осмотр"],
            html:
                "<h3>Перед тем как уехать</h3>" +
                "<ul>" +
                "<li>Сфотографируйте авто со всех сторон + салон + колёса.</li>" +
                "<li>Проверьте уровень топлива и правила возврата.</li>" +
                "<li>Уточните, включён ли Hi-Pass (для платных дорог).</li>" +
                "</ul>" +
                "<h3>На что обратить внимание</h3>" +
                "<ul>" +
                "<li>Франшиза/самоучастие (сколько платите при повреждении).</li>" +
                "<li>Ограничения по территориям/дорогам (иногда острова/паромы).</li>" +
                "</ul>",
        },
        {
            id: "rules",
            title: "Правила на дороге: самое важное",
            tags: ["правила", "скорость", "камеры", "полосы", "знаки"],
            html:
                "<h3>База</h3>" +
                "<ul>" +
                "<li>Движение правостороннее.</li>" +
                "<li>Скорость: много камер, лимиты меняются по участкам.</li>" +
                "<li>Школьные зоны/어린이 보호구역: строгие лимиты.</li>" +
                "</ul>" +
                "<h3>Полосы</h3>" +
                "<ul>" +
                "<li>Есть выделенные bus lane (особенно в Сеуле) — внимательно смотрите время действия.</li>" +
                "</ul>",
        },
        {
            id: "tolls",
            title: "Платные дороги и Hi-Pass",
            tags: ["платные дороги", "toll", "hi-pass", "оплата"],
            html:
                "<h3>Как оплачивать</h3>" +
                "<ul>" +
                "<li>Без Hi-Pass: выбирайте обычные полосы оплаты.</li>" +
                "<li>С Hi-Pass: проезжаете через выделенные полосы, оплата списывается автоматически.</li>" +
                "</ul>" +
                "<h3>Совет</h3>" +
                "<ul>" +
                "<li>В аренде уточняйте, кто и как платит за toll (сразу/потом/по выписке).</li>" +
                "</ul>",
        },
        {
            id: "parking",
            title: "Парковка: знаки, приложения, оплата",
            tags: ["парковка", "штраф", "знак", "оплата"],
            html:
                "<h3>Чеклист парковки</h3>" +
                "<ul>" +
                "<li>Смотрите таблички со временем/днями — правила часто разные.</li>" +
                "<li>Платные парковки могут требовать оплату в автомате или через приложение.</li>" +
                "</ul>" +
                "<h3>Полезные слова</h3>" +
                "<ul>" +
                "<li>주차 (чучха) — парковка</li>" +
                "<li>금지 (кымджи) — запрещено</li>" +
                "</ul>",
        },
        {
            id: "accident",
            title: "ДТП: что делать шаг за шагом",
            tags: ["дтп", "авария", "страховка", "полиция", "112", "119"],
            html:
                "<h3>Если случилось ДТП</h3>" +
                "<ul>" +
                "<li>Остановитесь безопасно, включите аварийку, поставьте знак (если есть).</li>" +
                "<li>Сфотографируйте место, машины, номера, повреждения.</li>" +
                "<li>Позвоните в страховую/прокат.</li>" +
                "</ul>" +
                "<h3>Экстренные номера</h3>" +
                "<ul>" +
                "<li>112 — полиция</li>" +
                "<li>119 — скорая/пожарные</li>" +
                "</ul>",
        },
        {
            id: "apps-driving",
            title: "Приложения для водителя",
            tags: ["навигация", "naver", "kakao", "карты", "переводчик"],
            html:
                "<h3>Мини-набор</h3>" +
                "<ul>" +
                "<li>Naver Map / KakaoMap — навигация и пробки.</li>" +
                "<li>Papago — перевод знаков и объяснений.</li>" +
                "</ul>" +
                "<h3>Лайфхак</h3>" +
                "<ul>" +
